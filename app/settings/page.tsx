      ...
      <section className="mx-auto max-w-3xl px-4 py-8 sm:py-10">
        <div className="mb-6 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-slate-500">
            {isBn ? "ইউজার সেটিংস" : "User Settings"}
          </p>
          <h1 className="mt-2 text-2xl font-bold text-slate-900 sm:text-3xl">
            {isBn ? "আপনার পছন্দমত সেটিংস" : "Your Personal Preferences"}
          </h1>
          <p className="mt-2 text-sm leading-6 text-slate-600 sm:text-base">
            {isBn
              ? "থিম, ভাষা, লেখার আকার এবং হাই কনট্রাস্ট মোড পরিবর্তন করুন। আপনার পছন্দ browser-এ সেভ থাকবে।"
              : "Change theme, language, text size, and contrast mode. Your preferences are saved in browser."}
          </p>
        </div>
        ...
        <div className="mt-6 grid gap-3 sm:grid-cols-2">
          ...
          >
            {isBn ? "✅ অর্ডার করতে যান" : "✅ Proceed to Checkout"}
          </Link>
        </div>
      </section>
