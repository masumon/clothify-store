      ...
      <header className={headerShellClass}>
        <div className="mx-auto flex max-w-6xl flex-col gap-3 px-4 py-3 sm:flex-row sm:items-center">
          ...
          <form
            ...
            className={`flex w-full items-center gap-2 rounded-full border px-2 py-1.5 sm:flex-1 ${
              isDarkMode
                ? "border-slate-600 bg-slate-900/80"
                : "border-slate-200 bg-white shadow-[0_10px_24px_-20px_rgba(15,23,42,0.7)]"
            }`}
          >
