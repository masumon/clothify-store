          ...
          <div className="flex flex-col gap-4 p-6">
            ...
            <div className="grid grid-cols-3 gap-2 rounded-2xl border border-slate-100 bg-slate-50 p-3">
              {[
                ...
                <div key={spec.label} className="text-center">
                  ...
                  <p className="mt-0.5 text-xs font-semibold text-slate-700">{spec.value}</p>
                </div>
              ))}
            </div>
            ...
            <div className="mt-auto flex flex-col gap-2.5">
              <button
                ...
                className="w-full rounded-2xl bg-slate-900 py-3 text-sm font-bold text-white transition hover:bg-slate-700 disabled:cursor-not-allowed disabled:opacity-50"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="w-full rounded-2xl bg-emerald-600 py-3 text-center text-sm font-bold text-white transition hover:bg-emerald-700"
              >
                💬 Order via WhatsApp
              </a>
              <Link
                ...
                onClick={onClose}
                className="w-full rounded-2xl border border-slate-200 py-2.5 text-center text-sm font-semibold text-slate-600 transition hover:bg-slate-50"
              >
                View Full Details →
              </Link>
            </div>
